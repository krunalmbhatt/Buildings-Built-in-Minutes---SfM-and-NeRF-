...
def main():
    ...
    for g in gen_imgs:
        ...
        plt.savefig('./output/Rendered_Image_'+str(i)+'.png', bbox_inches='tight', pad_inches=0, dpi=300)
    ...
    gif_out = './output/ship.gif'
    gif_in = []

    for i in range(200):
        gif_in.append('/output/Rendered_Image_'+str(i)+'.png')
